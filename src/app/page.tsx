          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {cropOptions.map((option, index) => (
              <Link
                ...
                className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-green-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold mb-4">AgriMitra</h3>
              <p className="text-green-100 mb-4">
                Empowering farmers with technology and knowledge to transform agriculture in India.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-green-100">support@agrimitra.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-green-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-green-800 mt-8 pt-8 text-center text-green-100">
            <p>&copy; {new Date().getFullYear()} AgriMitra. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
