...
import { TrendingUp, BarChart2, PieChart, Calendar, ArrowUpRight, ArrowDownRight } from 'lucide-react';
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
...
const crops: { [key: string]: CropData } = {
  'Wheat': {
    ...
    previousPrice: 2100,
    priceChange: 4.76,
    monthlyPrices: [2000, 2050, 2100, 2150, 2200, 2180, 2220, 2250, 2200, 2180, 2150, 2200],
    demandShare: 35,
  ...
  'Rice': {
    ...
    previousPrice: 2100,
    priceChange: -2.86,
    monthlyPrices: [2100, 2080, 2060, 2040, 2020, 2000, 2020, 2040, 2060, 2080, 2100, 2040],
    demandShare: 40,
  ...
  'Corn': {
    ...
    previousPrice: 1900,
    priceChange: 3.26,
    monthlyPrices: [1800, 1850, 1900, 1920, 1940, 1960, 1980, 1970, 1960, 1950, 1940, 1962],
    demandShare: 25,
...
export default function MarketAnalysis() {
  ...
  const marketShareData = {
    ...
    datasets: [
      {
        data: [crops[selectedCrop].demandShare, 100 - crops[selectedCrop].demandShare],
        backgroundColor: [
          'rgba(16, 185, 129, 0.8)',
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Track price trends, market demand, and seasonal patterns for agricultural commodities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
              ...
              <div className="space-y-2 mb-6">
                ...
                <p className="text-gray-600">Historical price movement for {selectedCrop} over the last {timeRange}</p>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="space-y-2 mb-6">
                <h3 className="text-xl font-semibold text-gray-900">Seasonal Demand Pattern</h3>
                <p className="text-gray-600">Monthly demand variations for {selectedCrop} throughout the year</p>
              </div>
              <div className="h-[200px]">
                <Bar data={seasonalityData} options={{
                  ...options,
                  plugins: {
                    ...options.plugins,
                    title: {
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="space-y-2 mb-6">
                <h3 className="text-xl font-semibold text-gray-900">{selectedCrop} Current Price</h3>
                <p className="text-gray-600">Latest market price and change</p>
              </div>
              <div className="text-3xl font-bold text-gray-900 mb-2">
                ₹{crops[selectedCrop].currentPrice}
                <span className="text-base font-normal text-gray-500">/quintal</span>
              </div>
              <div className={`flex items-center ${
                crops[selectedCrop].priceChange >= 0 ? 'text-emerald-500' : 'text-red-500'
              }`}>
                ...
                <span className="font-medium">{Math.abs(crops[selectedCrop].priceChange)}%</span>
                <span className="text-gray-600 ml-2 text-sm">vs last month</span>
              </div>
            </div>

            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="space-y-2 mb-6">
                <h3 className="text-xl font-semibold text-gray-900">{selectedCrop} Market Share</h3>
                <p className="text-gray-600">Current market demand distribution</p>
              </div>
              <div className="h-[200px] flex items-center justify-center">
                <Pie data={marketShareData} options={{ 
                  responsive: true,
                  plugins: { 
              ...
              <div className="text-center mt-4">
                <span className="text-2xl font-bold text-emerald-500">{crops[selectedCrop].demandShare}%</span>
