...
import { FaSeedling, FaWater, FaRecycle, FaBug, FaSun, FaLeaf, FaTree, FaCloudSun, FaDumpster, FaTractor } from 'react-icons/fa';
...
const SustainableFarming: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className={`text-5xl font-bold text-green-700 mb-4 ${hind.className}`}>
          सतत खेती की विधियां
        </h2>
              ...
              >
                <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    >
                      <span className={`${hind.className} font-medium text-green-700`}>{technique.title.split('|')[0]}</span>
                      <span className="ml-2 text-green-700">{technique.title.split('|')[1]}</span>
                    </motion.h4>
                    ...
                    <motion.div 
                      ...
                      className="space-y-2"
                    >
                      <p className="text-lg text-green-700 font-medium">{technique.description.en}</p>
                      <p className={`${hind.className} text-lg text-green-700 font-medium`}>{technique.description.hi}</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="border-t border-green-100 pt-3">
                        ...
                        >
                          ...
                          <span className={`${hind.className} ml-2 font-medium`}>| कार्यान्वयन चरण</span>
                        </motion.h5>
                        <ul className="space-y-2">
                          {technique.steps.map((step, idx) => (
                            ...
                            >
                              ...
                              <span className={`${hind.className} font-medium`}>{step.hi}</span>
                            </motion.li>
                          ))}
                        </ul>
                      </div>
