...
import { Sun, Cloud, CloudRain, Snowflake, Calendar, Clock, Droplet } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white -mt-[88px] pt-[88px]">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Seasonal Planting Guide</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Learn the best times to plant and harvest your crops throughout the year</p>
        </div>
          ...
          {seasonalData.map((season) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
                <div className={`${season.textColor} p-4 rounded-2xl bg-white shadow-md transition-transform duration-300 hover:scale-110 hover:rotate-12 self-start`}>
                  {season.icon}
                </div>
                  ...
                  >
                    ...
                    <div className="space-y-4 transform opacity-90 transition-all duration-300 group-hover:opacity-100">
                      <div className="flex items-start gap-3 transition-all duration-300 group-hover:translate-x-1">
                        ...
                        <div>
                          <p className="text-sm font-medium text-emerald-600 mb-1">Planting Time</p>
                      ...
                      <div className="flex items-start gap-3 transition-all duration-300 group-hover:translate-x-1">
                        ...
                        <div>
                          <p className="text-sm font-medium text-emerald-600 mb-1">Harvest Time</p>
                      ...
                      <div className="flex items-start gap-3 transition-all duration-300 group-hover:translate-x-1">
                        ...
                        <div>
                          <p className="text-sm font-medium text-emerald-600 mb-1">Ideal Conditions</p>
